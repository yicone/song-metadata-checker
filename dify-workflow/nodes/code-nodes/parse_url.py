...
def main(song_url: str) -> ParseUrlOutput:
    ...
    try:
        ...
        if "id" in query_params:
            ...
            return {"song_id": song_id, "success": True, "error": ""}
        else:
            return {"song_id": None, "success": False, "error": "URL 中未找到 id 参数"}

    except Exception as e:
        return {"song_id": None, "success": False, "error": f"URL 解析失败: {str(e)}"}
